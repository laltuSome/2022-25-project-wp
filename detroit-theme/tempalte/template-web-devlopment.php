...
<section class="section section-inner1 pt-0">
	<div class="container">
		<div class="row align-items-center">
...
<?php if( have_rows('serv_sider') ): ?>
	...
	<div class="col-lg-4 col-md-4 col-12">
			<a href="#" class="ser-box padin-around matchHeight">
...
<section class="section section-inner1 pt-0">
	<div class="container">
		...
		<div class="col-lg-4 col-md-12 col-12">
			<div class="body-content-postion">
	
<?php the_field('3s_content'); ?>
...
<section class="separeter text-center"><span class="lines-space"></span></section>
...
<?php endif; ?>
		...
		<div class="col-lg-4 col-md-12 col-12">
			<div class="body-content-postion2">
	
<?php the_field('5s_content'); ?>
...
<div class="row pt-5">
		<?php if( have_rows('content_sider') ): ?>
	 <?php while( have_rows('content_sider') ): the_row(); 
        $image = get_sub_field('image');
        ?>
...
<div class="holders-icons ">
	<div class="bg-imgs"> <?php echo wp_get_attachment_image( $image, 'full' ); ?></div>
	   
            <p class="titels"><?php the_sub_field('caption'); ?></p>
</div>
</div>
    <?php endwhile; ?>
<?php endif; ?>
