<?php /* Template Name: Social Media Template */ ?>
...
<section class="section section-logosfull pt-1">
	<div class="container">
		<div class="row">
			<div class="col-12">
					<div class="body-content text-center">
...
<?php if( have_rows('socil_slide') ): ?>
	 <?php while( have_rows('socil_slide') ): the_row(); 
        $image = get_sub_field('image');
        ?>
  <button class="tablinks" onclick="openCity(event, '<?php the_sub_field('name'); ?>')" id="defaultOpen"><?php the_sub_field('icon'); ?></button>
  <?php endwhile; ?>
<?php endif; ?>
</div>
...
<div class="col-lg-6 col-md-6 col-12">
		<div class="image-holder"> <?php echo wp_get_attachment_image( $image, 'full' ); ?></div>
</div>
<div class="col-lg-6 col-md-6 col-12">
	<div class="body-content scoilcontent">
		<strong class="soil-ins"><?php the_sub_field('icon'); ?>	 <?php the_sub_field('name'); ?></strong>
...
<?php endif; ?>
	...
	<section class="section section-logos-dark overflow-visible" style="background:url('<?php the_field('bg_images'); ?>')">
	<div class="container">
		<div class="row">
			<div class="col-12">
					<div class="body-content white-text text-center mb-5">
...
<div class="row">
<?php if( have_rows('icon_sider1') ): ?>
	 <?php while( have_rows('icon_sider1') ): the_row(); 
        $image = get_sub_field('image');
        ?>
<div class="col-lg-3 col-md-3 col-6">
<div class="holders-icons-white matchHeight">
<div class="imag-logos"><?php echo wp_get_attachment_image( $image, 'full' ); ?></div>
...
<?php endif; ?>
	...
	<section class="section section-logos-top" >
	<div class="container">
		<div class="row">
			<div class="col-12">
					<div class="body-content text-center">
		<?php the_field('4rd_content'); ?>
</div>
			</div>
...
<div class="holders-icons matchHeight">
<div class="imag-logos"><?php echo wp_get_attachment_image( $image, 'full' ); ?></div>
  <p><?php the_sub_field('caption'); ?></p>
</div>
</div>
