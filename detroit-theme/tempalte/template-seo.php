<?php /* Template Name: SEO Template */ ?>
...
<?php endif; ?>
		...
		<div class="col-lg-8 col-md-12 col-12">
			<div class="body-content pading-right">
				<span class="samll-titel">We Provide </span>
...
<a class="btn-fill" href="#"><span>Get In Touch</span></a>
	...
	<section class="section section-middle-content mt-0">
	<div class="container">
...
<div class="col-lg-3 col-md-3 col-12">
	<?php if( have_rows('seo_lefte') ): ?>
	 <?php while( have_rows('seo_lefte') ): the_row(); 
        $image = get_sub_field('image');
        ?>
<div class="left-content-line1"> 
<h4><?php the_sub_field('titel'); ?> <i class="fa fa-check-circle"></i></h4>
...
<div class="col-lg-3 col-md-3 col-12">
	<?php if( have_rows('seo_rights') ): ?>
	 <?php while( have_rows('seo_rights') ): the_row(); 
        $image = get_sub_field('image');
        ?>
<div class="right-content-line1"> <h4><i class="fa fa-check-circle"></i><?php the_sub_field('titel'); ?></h4>
<?php the_sub_field('data'); ?></div>
...
<div class="holders-icons text-left">
...
<div class="col-lg-12">
	...
	<?php if( have_rows('seo_sider') ): ?>
	 <?php while( have_rows('seo_sider') ): the_row(); 
        $image = get_sub_field('image');
        ?>
...
<div class="item-slider">
	...
	<div class="row">
		<div class="col-lg-6 col-md-6 col-12">
			<div class="body-lisder">
			<?php the_sub_field('caption'); ?>
		</div>
		</div>
		<div class="col-lg-6 col-md-6 col-12">
			<div class="holder-liser"> <?php echo wp_get_attachment_image( $image, 'full' ); ?></div>
		</div>
	</div>
