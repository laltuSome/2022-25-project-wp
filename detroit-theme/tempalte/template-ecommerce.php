<?php /* Template Name: ecommerce Template */ ?>
...
<?php endif; ?>
		...
		<div class="col-lg-7 col-md-12 col-12">
			<div class="body-content pading-right">
				<span class="samll-titel">Design And Develop Your </span>
...
<a class="btn-fill mt-5" href="#"><span>READ MORE</span></a>
			</div>
		</div>
		<div class="col-lg-5 col-md-12 col-12">
