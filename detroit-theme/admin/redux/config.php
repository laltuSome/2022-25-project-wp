<?php
  ...
  //  $args['admin_bar_links'][] = array(
   ...
   // );
    ...
    $args['footer_text'] = __( '<p>This Theme Option is proudly developed by </p>', 'redux-framework-demo' );
 ...
 array(
         ...
         array(
                'id'       => 'book-text',
                'type'     => 'editor',
                'title'    => __( 'Book Text', 'redux-framework-demo' ),
               ),
         array(
                'id'       => 'book-url',
                'type'     => 'text',
                'title'    => __( 'Book Url', 'redux-framework-demo' ),
               ),
     ...
     Redux::setSection( $opt_name, array(
        'title'      => __( 'Frequently Asked Questions', 'redux-framework-demo' ),
        'id'         => 'faq-slide',
   'icon'   => 'el el-laptop',
        'subsection' => true,
        'fields'     => array(
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
             ...
             array(
                'id'       => 'banner-product',
                'type'     => 'media',
                'title'    => __( 'Banner Images', 'redux-framework-demo' ),
   ...
   array(
       ...
       Redux::setSection( $opt_name, array(
        'title'  => __( 'Area Page', 'redux-framework-demo' ),
        'id'     => 'area-bg',
        'desc'   => __( 'From here you can change area part of your website.', 'redux-framework-demo' ),
        'icon'   => 'el el-laptop',
        'fields' => array(
             array(
                'id'       => 'area-titel',
                'type'     => 'text',
                'title'    => __( 'Areas', 'redux-framework-demo' ),
