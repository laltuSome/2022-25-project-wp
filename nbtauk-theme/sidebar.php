...
<ul class="catagori-list">
    <?php wp_list_categories( array(
        'orderby'    => 'name',
        'show_count' => false,
        'title_li' => '<h4 class="side-heading">' . __( 'All Courses', 'textdomain' ) . '</h4>',
        'exclude'    => array( 1 )
    ) ); ?> 
</ul>
...
<h4>Latest Post</h4>
	<?php $postslist = get_posts(array('post_type'=>'blogs')); foreach ($postslist as $post) : setup_postdata($post); ?>
