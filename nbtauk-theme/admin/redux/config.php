<?php
 ...
 array(
         ...
         array(
                'id'       => 'clients-text',
                'type'     => 'editor',
                'title'    => __( 'Clients Text', 'redux-framework-demo' ),
                'args'   => array(
            'teeny'            => true,
            'textarea_rows'    => 10
        )
         ...
         array(
                'id'       => 'clients-url',
                'type'     => 'media',
                'title'    => __( 'clients Image Url', 'redux-framework-demo' ),
               ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                'id'          => 'home-slides',
                'type'        => 'slides',
                'title'       => __( 'Home Slides Options', 'redux-framework-demo' ),
                'subtitle'    => __( 'Unlimited Add Review with drag and drop sortings.', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
			...
			array(
                ...
                'id'       => 'phone-footer1',
                'type'     => 'text',
                'title'    => __( 'Phone (Business)', 'redux-framework-demo' ),
                'subtitle'     => __( 'Upload phone', 'redux-framework-demo' ),
            ),
                 array(
                'id'       => 'phone-footer2',
                'type'     => 'text',
                'title'    => __( 'Phone (Mobile)', 'redux-framework-demo' ),
                'subtitle'     => __( 'Upload phone', 'redux-framework-demo' ),
            ),
